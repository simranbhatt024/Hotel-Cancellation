...
SQL – For data extraction and preliminary querying from the database.

Python – Core programming language used for data analysis and processing.

Pandas – For data cleaning, manipulation, and exploration.

NumPy – To support efficient numerical computations and statistical operations.

Excel – Used for initial data inspection and simple visualizations.

Plotly – For creating interactive and visually engaging charts.

Jupyter Notebook – To document the workflow, code, and analysis in a readable format.
